...
public:
     ...
     */
    void disconnect();
    void cinc_subscribe_scope(const string , const string, unsigned char) ;
    void kc_subscribe(const string&, const string&, unsigned char, unsigned char) ;
    void kc_publish(const string&, const string&, unsigned char, unsigned char) ;
protected:
