...
public:
    ...
    Scope(unsigned char _strategy, Scope *father_scope, unsigned char _scope_type) ;
    /**
    ...
    unsigned char scope_type ;//indicate what type is this scope, e.g file or chunk etc.
};
