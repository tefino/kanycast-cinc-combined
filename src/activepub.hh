...
public:
    ...
    /**@brief kc:**/
    HashTable<String, BABitvector> kc_rp_FID ;
    HashTable<String, unsigned int> kc_rp_dis ;
    HashTable<String, BABitvector> kc_rp_p2sfid ;
    HashTable<String, String> kc_chunkid_nodeid ;
    unsigned char kc_noofcr ;
    BABitvector fid2pub ;//fid to publisher
    BABitvector fid2sub ;//fid from publisher
};
