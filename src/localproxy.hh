...
public:
    ...
    /**@brief kc: after receive all the information from publisher(s) and cache router(s), the subscriber begin
     * to retrieve the content according to these information*/
    void kc_beginRetrieve(ActiveSubscription*) ;
    /**@brief kc: ask the publish application to push data to subscriber**/
    void kc_AskPubPushData(Packet*) ;
